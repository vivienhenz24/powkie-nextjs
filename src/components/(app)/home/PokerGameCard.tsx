...
export function PokerGameCard({ house, date, time, players, buyIn }: PokerGameCardProps) {
  return (
    <div className="p-4 rounded-lg border border-border bg-card hover:bg-accent transition-colors cursor-pointer">
      <div className="flex items-start justify-between mb-2">
        <h3 className="font-medium text-foreground">{house} House</h3>
